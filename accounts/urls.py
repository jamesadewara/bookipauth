...
from .views import SubscriptionToggleView, MainUserDetailUpdateView
# CSRF needd for session based requests
...
urlpatterns = [
    ...
    path('authjwt/user/me', MainUserDetailUpdateView.as_view(), name='user-detail'),
