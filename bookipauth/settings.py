"""
Django settings for bookipauth project.
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER')  # Replace with your Mailgun domain email
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')  # Replace with your Mailgun SMTP password
MAILGUN_API_KEY = config('MAILGUN_API_KEY')
MAILGUN_DOMAIN = EMAIL_HOST_USER
